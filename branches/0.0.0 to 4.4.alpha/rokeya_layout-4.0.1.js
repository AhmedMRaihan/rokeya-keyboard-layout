...
Keyboard.prototype.handleKeyboardInput = function (oEvent,oSource) {
    ...
    var prev = "", prevPrev = "", prevCharacterType=0, next = "", nextNext = "", text = this.textInputSource.value;
    ...
    ***************************************/
	...
	if (keyState.replaceLastChar) {
        ...
        // other
        else keyState.unicodeKey = this.global.bd.getFollower(prev, 2);
	...
	// replace vowel in full-form
	/*
	if(prev!="" && prev==keyState.unicodeKey && (prevCharacterType == 2 || prevCharacterType == 7))
	{		
	...
	else if (keyState.characterType == 2 && (prevCharacterType == 1 || prevCharacterType == 3) == false) {
	
        keyState.unicodeKey = this.global.bd.getFollower(keyState.unicodeKey, 2);
    }
	*/
	// change vowel in full-form to kar-form if prevCharacterType is consonant/fola
	if (keyState.characterType == 7 && (prevCharacterType == 1 || prevCharacterType == 3)) {
        keyState.unicodeKey = this.global.bd.getFollower(keyState.unicodeKey, 2);
    }
	
    // prev is hasanta but current key is not consonant/fola...
    if (prev == "\u09CD" && keyState.unicodeKey.length > 0 &&
        (keyState.characterType == 1 || keyState.characterType == 3) == false) {

        keyState.unicodeKey = this.global.ZWNJ + keyState.unicodeKey;
    }
...
function GlobalVariable() {
	...
	[
		...
		["\u0989", "\u098a"], // uttom and usha...... U
		["\u09ad", "\u0982"], // vrammoman and itong-bitong...... V
		["\u098b", "\u09a7"], // rii-kar and dhakesshori...... W
...
[
	["\u200d", 5, ""], ["\u0964", 6, "\u002e"], ["\u0981", 6, ""], ["\u0982", 6, ""], ["\u0983", 6, ""], ["\u0985", 7, ""], ["\u0986", 7, "\u200d\u09BE"], ["\u0987", 7, "\u200d\u09bf"], ["\u0988", 7, "\u200d\u09c0"], ["\u0989", 7, "\u200d\u09c1"], ["\u098a", 7, "\u200d\u09c2"], ["\u098b", 7, "\u200d\u09c3"], ["\u098f", 7, "\u200d\u09c7"], ["\u0990", 7, "\u200d\u09c8"], ["\u0993", 7, "\u200d\u09cb"], ["\u0994", 7, "\u200d\u09cc"], /*kobor*/["\u0995", 1, "\u0996"], ["\u0996", 1, ""], ["\u0997", 1, "\u0998"], ["\u0998", 1, ""], ["\u0999", 1, ""], /*cholonto*/["\u099a", 1, "\u099b"], ["\u099b", 1, ""], ["\u099c", 1, "\u099d"], ["\u099d", 1, ""], ["\u099e", 1, ""], /*tonkar*/["\u099f", 1, "\u09a0"], ["\u09a0", 1, ""], ["\u09a1", 1, "\u09a2"], ["\u09a2", 1, ""], ["\u09a3", 3, ""], /*tutul*/["\u09a4", 1, "\u09a5"], ["\u09a5", 1, ""], ["\u09a6", 1, "\u09a7"], ["\u09a7", 1, ""], ["\u09a8", 1, ""], /*paloan*/["\u09aa", 1, "\u09ab"], ["\u09ab", 1, ""], ["\u09ac", 3, "\u09ad"], ["\u09ad", 1, ""], ["\u09ae", 1, ""], ["\u09af", 3, ""], ["\u09b0", 3, "\u09dc"], ["\u09b2", 1, ""], /*shosank*/["\u09b6", 1, ""], ["\u09b7", 1, ""], ["\u09b8", 1, "\u09b6"], ["\u09b9", 1, ""], /*ami-amra*/["\u09be", 2, "\u0986"], ["\u09bf", 2, "\u0987"], ["\u09c0", 2, "\u0988"], ["\u09c1", 2, "\u0989"], ["\u09c2", 2, "\u098a"], ["\u09c3", 2, "\u098b"], ["\u09c7", 2, "\u098f"], ["\u09c8", 2, "\u0990"], ["\u09cb", 2, "\u0993"], ["\u09cc", 2, "\u0994"], ["\u09cd", 4, "\u09cd\u200c"], ["\u09ce", 6, "\u0988"], ["\u09d7", 2, "\u0988"], ["\u09dc", 1, "\u09dd"], ["\u09dd", 1, ""], ["\u09df", 1, ""], ["\u09e4", 6, ""], ["\u09f7", 1, "\u002e"], ["\u09fb", 1, ""], ["\u09fc", 1, ""]
];
